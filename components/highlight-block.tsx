  ...
  return (
    <div>
      <Link passHref={isExternalLink} target={isExternalLink ? "_blank" : "_self"} href={link}>
        <div className='bordder box-border grid max-w-xs grid-cols-12 items-center gap-3 rounded-lg border-2 border-neutral-100 bg-neutral-50 hover:scale-105 hover:border-neutral-700 dark:border-slate-700 dark:bg-slate-800 hover:dark:border-slate-50 sm:gap-4'>
          {/* HIGHLIGHT TITLE */}
